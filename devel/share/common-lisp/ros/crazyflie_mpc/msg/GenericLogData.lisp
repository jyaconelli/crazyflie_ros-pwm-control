...
(cl:defmethod cl:initialize-instance :after ((m <GenericLogData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GenericLogData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_mpc-msg:<GenericLogData> is deprecated: use crazyflie_mpc-msg:GenericLogData instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <GenericLogData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_mpc-msg:header-val is deprecated.  Use crazyflie_mpc-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'values-val :lambda-list '(m))
(cl:defmethod values-val ((m <GenericLogData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_mpc-msg:values-val is deprecated.  Use crazyflie_mpc-msg:values instead.")
  (values m))
