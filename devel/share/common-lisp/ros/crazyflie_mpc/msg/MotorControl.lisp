...
(cl:defmethod cl:initialize-instance :after ((m <MotorControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_mpc-msg:<MotorControl> is deprecated: use crazyflie_mpc-msg:MotorControl instead.")))

(cl:ensure-generic-function 'm1-val :lambda-list '(m))
(cl:defmethod m1-val ((m <MotorControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_mpc-msg:m1-val is deprecated.  Use crazyflie_mpc-msg:m1 instead.")
  (m1 m))
