...
def callback(data):
  ...
  #print "\n\n\n\ntime: ", millis()
  #rospy.loginfo(rospy.get_caller_id() + "I heard this %s %s %s %s %s %s %s", data.values[0],
  #data.values[1],
  #data.values[2],
  #data.values[3],
  #data.values[4],
...
################################ MPC ####################################
  mpc1 = MPController(newNN, crazy, dt_x, dt_u, origin_minimizer, N=10, T=3, variance = .00003)
  print('...MPC Running')
